...
$routes->get('anggota/hapus-data-anggota/(:any)', 'Anggota::hapus_data_anggota/$1');
...
$routes->get('admin/master-buku', 'Admin::master_buku'); // Jika ada halaman daftar buku
$routes->get('admin/edit-buku/(:any)', 'Admin::edit_buku/$1');
$routes->post('admin/update-buku', 'Admin::update_buku');
$routes->get('admin/hapus-buku/(:any)', 'Admin::hapus_buku/$1');
